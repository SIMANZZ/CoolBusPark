...
namespace CBP
{
    public partial class MainForm : Form
    {
        ...
        SQLiteConnection DB;
        SQLiteCommand CMD;
        DataTable Routes, Drivers, BusStations, Buses;
        public MainForm()
        {
        ...
        {
            Button[] ButtonsAndIcons = { RoutesButton, RouteIcon, StationsButton, StationIcon, DriversButton, DriverIcon, BusesButton, BusIcon };
